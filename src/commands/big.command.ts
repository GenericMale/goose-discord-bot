...
import {GuildMember, MessageEmbedOptions, PermissionResolvable} from 'discord.js';
...
export class BigCommand extends Command {
    ...
    private async executeUser(author: GuildMember, userId: string): Promise<MessageEmbedOptions> {
    ...
    private async executeEmoji(emoji: string, emojiSize: number): Promise<MessageEmbedOptions> {
